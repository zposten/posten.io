...
export default class Footer extends Component {
  ...
  render() {
    ...
    let twitterLink = (
      <a href="https://github.com/zposten" role="button" title="GitHub">
    ...
    let githubLink = (
      <a href="https://twitter.com/zachposten" role="button" title="Twitter">
        <svg width="36" height="36" viewBox="0 0 24 24">
          <path
    ...
    return (
      <footer className={s.footer, 'site-footer'}>
        <div>
          { twitterLink }
          { githubLink }
        </div>
