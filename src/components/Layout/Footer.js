...
export default class Footer extends Component {
  ...
  render() {
    const LinkIcon = (props) => (
      <a href={props.to} role="button" target="_blank" title={props.title} className={'hvr-bounce-in'}>
        <SvgIcon style={{width: 36, height: 36, color: colors.TEXT}} hoverColor={colors.PRIMARY} viewBox={props.viewBox}>
          {props.children}
        </SvgIcon>
      </a>
    );
    ...
    let githubLink = (
      <LinkIcon to={'https://twitter.com/zachposten'} title={'Twitter'}>
        <path
    ...
    const facebookLink = (
      <LinkIcon to={'https://facebook.com/zach.posten'} title={'Facebook'} viewBox={'0 0 65 65'}>
        <path d="M28.765,50.32h6.744V33.998h4.499l0.596-5.624h-5.095
        l0.007-2.816c0-1.466,0.14-2.253,2.244-2.253h2.812V17.68h-4.5c-5.405,0-7.307,
        2.729-7.307,7.317v3.377h-3.369v5.625h3.369V50.32z
        M33,64C16.432,64,3,50.568,3,34C3,17.431,16.432,4,33,4s30,13.431,30,30C63,
        50.568,49.568,64,33,64z"/>
      </LinkIcon>
    )
